...
//    @GeneratedValue(strategy = GenerationType.IDENTITY)
    ...
    /**
     * Creates a user based on name, family, userName, and salary.
     */
    public User(@NotNull Integer id, @NotNull(message = "Name is mandatory") String name, String family, @NotNull @Size(min = 2, message = "Name should have at least 2 characters") String userName, double salary) {
        this.id = id;
        this.name = name;
        this.family = family;
...
//    public User(@NotNull(message = "Name is mandatory") String name, String family, @NotNull @Size(min = 4, message = "Name should have at least 2 characters") String userName, double salary) {
//        this.name = name;
//        this.family = family;
//        this.userName = userName;
//        this.salary = salary;
